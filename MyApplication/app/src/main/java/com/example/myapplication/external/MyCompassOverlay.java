...
public class MyCompassOverlay extends Overlay implements IOverlayMenuProvider, IOrientationConsumer {
    ...
    private float mCompassCenterX = 50.0f;
    private float mCompassCenterY = 50.0f;
    private final float mCompassRadius = 25.0f;
    ...
    public MyCompassOverlay(Context context, IOrientationProvider orientationProvider,
        ...
        mCompassFrameCenterX = mCompassFrameBitmap.getWidth() / 2 ;
        mCompassFrameCenterY = mCompassFrameBitmap.getHeight() / 2 ;
        mCompassRoseCenterX = mCompassRoseBitmap.getWidth() / 2 ;
        mCompassRoseCenterY = mCompassRoseBitmap.getHeight() / 2 ;
