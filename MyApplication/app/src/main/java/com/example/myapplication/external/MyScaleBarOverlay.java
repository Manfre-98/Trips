...
public class MyScaleBarOverlay extends Overlay implements GeoConstants {
    ...
    org.osmdroid.views.overlay.ScaleBarOverlay.UnitsOfMeasure unitsOfMeasure = org.osmdroid.views.overlay.ScaleBarOverlay.UnitsOfMeasure.metric;
    ...
    public MyScaleBarOverlay(final MapView mapView) {
     ...
     * @since 6.1.0
     */
    public MyScaleBarOverlay(final Context pContext, final int pMapWidth, final int pMapHeight) {
     ...
     * @since 6.1.0
     */
    private MyScaleBarOverlay(final MapView pMapView, final Context pContext, final int pMapWidth, final int pMapHeight) {
        super();
        mMapView = pMapView;
        context = pContext;
        mMapWidth = pMapWidth;
     ...
     */
    public void setUnitsOfMeasure(org.osmdroid.views.overlay.ScaleBarOverlay.UnitsOfMeasure unitsOfMeasure) {
     ...
     */
    public org.osmdroid.views.overlay.ScaleBarOverlay.UnitsOfMeasure getUnitsOfMeasure() {
    ...
    private double adjustScaleBarLength(double length) {
        long pow = 0;
        boolean feet = false;
        if (unitsOfMeasure == org.osmdroid.views.overlay.ScaleBarOverlay.UnitsOfMeasure.imperial) {
        ...
        } else if (unitsOfMeasure == org.osmdroid.views.overlay.ScaleBarOverlay.UnitsOfMeasure.nautical) {
        ...
        if (feet)
            length = length / GeoConstants.FEET_PER_METER;
        else if (unitsOfMeasure == org.osmdroid.views.overlay.ScaleBarOverlay.UnitsOfMeasure.imperial)
            length = length * GeoConstants.METERS_PER_STATUTE_MILE;
        else if (unitsOfMeasure == org.osmdroid.views.overlay.ScaleBarOverlay.UnitsOfMeasure.nautical)
            length = length * GeoConstants.METERS_PER_NAUTICAL_MILE;
